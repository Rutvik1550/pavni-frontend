...
const Contact = () => {
    useDocTitle('Pavni Chemicals - Send us a message')
    ...
    const sendEmail = (e) => {
        ...
        axios({
            method: "post",
            url: "http://localhost:3000/api/contact/send-mail",
            data: {
                firstName,
                lastName,
                email,
                        ...
                        <div className="flex flex-col text-white">
                            ...
                            <div className="flex my-4 w-2/3 lg:w-3/4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">Plot No. 307+308 to 311/50, Nr. Ramdev pir Chokadi, GIDC Ankleshwar - 393002</p>
                                </div>
                            </div>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">Tel: +91 9687370005</p>

                                    <div className='mt-5'>
                                        <h2 className="text-2xl">Send an E-mail</h2>
                                        <p className="text-gray-400">pavnichemicals@gmail.com</p>
                                    </div>
